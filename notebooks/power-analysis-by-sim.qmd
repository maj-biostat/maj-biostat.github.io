...
The probability of detecting an effect for each trial is equal to the power.
Therefore, if we interpolate over these points, we can produce an approximation of the power curve over the entire range.
...
ggplot(d_fig_1, aes(x = x, y = win)) +
  ...
  scale_y_continuous("Pr(theta > 0) > 0.975", breaks = seq(0, 1, by = 0.1)) +
