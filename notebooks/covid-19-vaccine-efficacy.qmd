...
The prior on $\theta$, the case proportion, implies a prior probability that VE is greater than 0.3 equal to `r sprintf("%.1f", mean(d_VE$prior > 0.3))`.
However, the posterior probability that VE is greater than 0.3 is `r sprintf("%.1f", mean(d_VE$posterior > 0.3))`. 
