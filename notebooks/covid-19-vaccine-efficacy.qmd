...
where $\pi_v$, $\pi_p$ are the probabilities of infection under the vaccine and placebo (i.e. the risk of infection without infection), generally expressed as a percentage.
...
If we can reasonably assume that $p_v \le p_c$ (implying the risk of infection is going to be lower on receipt of the vaccine than on placebo) then the lower bound of VE will be constrained to zero.
However, when we cannot make this assumption and $p_v > p_c$ then VE may become negative.
