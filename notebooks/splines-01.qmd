...
If we assume $0 < x < 10$ with $K = 2$ breakpoints, one at $x = 3$ and the other at $x = 6$ then we get $K + 1 = 3$ segments, i.e. 

+ Segment 1: $0 \le x \le 3$ for which the slope is $\beta_1$
+ Segment 2: $3 < x \le 6$ for which the slope is $\beta_1 + \delta_1$
+ Segment 4: $x > 6$ for which the slope is $\beta_1 + \delta_1 + \delta_2$
